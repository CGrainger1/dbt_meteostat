WITH hourly_data AS (
    ...
    SELECT *
		,(CASE 
        WHEN time >= '23:00'::time OR time < '06:00'::time THEN 'night'
        WHEN time BETWEEN '06:00'::time AND '17:59'::time THEN 'day'
        WHEN time BETWEEN '18:00'::time AND '22:59'::time THEN 'evening'
		END) AS day_part
    FROM add_features
)
SELECT *
